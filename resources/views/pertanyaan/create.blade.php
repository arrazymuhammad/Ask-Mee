			...
			<div class="inner-question main ask-question-main">
				<form method="post" action="{{url('question')}}">
					...
					<div class="form-group">
						...
						<input class="form-control" name="judul" type="text" placeholder="Judul Pertanyaan" required>
					</div>
					<div class="form-group">
						<label>Deskripsi Pertanyaan</label>
						<div class="alert alert-info">Seluruh Tag HTML dapat diselipkan kecuali tag &lt;script&gt;</div>
						<textarea name="content" class="textarea form-control" required></textarea>
					</div>
					<div class="form-group tage-input-main">
						<label>Tags</label>
						<div class="alert alert-info">Pisahkan dengan koma. (misal : tag1, tag2, tag3)</div>
						<input id="tags" name="tags" class="tags-input w-100" type="text" placeholder="" required>
					</div>
					<div class="form-group">
